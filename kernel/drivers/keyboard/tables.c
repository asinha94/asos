...
kbd_event scancode_set1[KBD_SCAN_CODES] = {
    [0x01] = { ASCII_ESCAPE, ASCII_ESCAPE, KBD_MASK_NONE }, // ESC - Replace with cmd/fn
    ...
    [0x0E] = { KBD_INPUT_NONE, KBD_INPUT_NONE, KBD_MASK_NONE }, // Backspace - Replace with cmd/fn?
    ...
    [0x1C] = { ASCII_LINE_FEED, ASCII_LINE_FEED, KBD_MASK_NONE }, // ENTER replace with cmd/fn?
    [0x1D] = { KBD_INPUT_NONE, KBD_INPUT_NONE, KBD_MASK_CTRL }, //LCTRL
    ...
    [0x29] = { ASCII_LOWER_L, ASCII_UPPER_L, KBD_MASK_SHIFT },
    [0x2A] = { ASCII_LOWER_L, ASCII_UPPER_L, KBD_MASK_SHIFT },
    [0x2B] = { ASCII_LOWER_L, ASCII_UPPER_L, KBD_MASK_SHIFT },
    [0x2C] = { ASCII_LOWER_L, ASCII_UPPER_L, KBD_MASK_SHIFT },
    [0x2D] = { ASCII_LOWER_L, ASCII_UPPER_L, KBD_MASK_SHIFT },
};
